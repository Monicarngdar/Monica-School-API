...
(44, 31, 20, 'Task 4', 'Prototyping and Testing', 100, '2026-04-04'),
(45, 31, 19, 'Task 3', 'Documentation', 100, '2026-05-29');
...
INSERT INTO `attendance` (`attendanceId`, `userAccountId`, `unitId`, `unitTimetableId`, `date`, `status`) VALUES
(25, 25, 19, 13, '2026-03-30', 'present'),
(26, 25, 19, 13, '2026-03-31', 'present'),
(27, 25, 19, 13, '2026-04-07', 'present'),
(28, 25, 19, 13, '2026-04-08', 'absent'),
(29, 25, 19, 13, '2026-04-09', 'late');
...
(59, 'adminuser', 'kiarastudent', 'Test ', 'Test', 'messageAttachments/kiarastudent-test-php.pdf6972774def67a6.64028281.pdf', '2026-01-22 20:15:25', 1);
...
--
-- Dumping data for table `messageoutbox`
--

INSERT INTO `messageoutbox` (`messageId`, `senderUsername`, `messageSubject`, `messageBody`, `attachment`, `sendDateTime`) VALUES
(41, 'adminuser', 'Test ', 'Test', 'messageAttachments/adminuser-test-php.pdf6972774de63479.13221239.pdf', '2026-01-22 20:15:25');
...
INSERT INTO `recipient` (`messageId`, `recipientUsername`) VALUES
(41, 'kiarastudent');
...
(21, 13, '1', 'API Systems', 'API (Application Programming Interface) is a set of rules and protocols that allows different software applications to communicate, exchange data, and share functionality securely.');
...
INSERT INTO `user_account` (`userId`, `roleId`, `username`, `password`, `token`) VALUES
(25, 1, 'kiarastudent', '$2y$10$Ha3KZgh/S1Sq/jejlIg/AeOdobBjnZCcpYYEbbR.ETQ7dLAruNjAO', 'ya29.a0AfH6SMC_xL5Rz8N2vV8qZ3kL1mP9nO0pQ7rS2tU4vW6xY8zA0bC2dE4fG6hI8jK'),
(30, 3, 'adminuser', '$2y$10$EmozcJnghfhLMYOGJP9eQeg/nZs8MnO9cv6bWt6Vg1owVrQF9NpJK', 'ghp_7kL9mN1oP3qR5sT7uV9wX1yZ3bA5cD7eF9gH1iJ3kL5mN7oP9qR1sT3uV5wX7y'),
(31, 2, 'zoelecturer', '$2y$10$/dVFQvdth376hRU2qTucFOjrP9EENUI5A33OWF7UXY.KAMXdpL/K2', 'at_3k2j1h0g9f8e7d6c5b4a3z2y1x0w9v8u7t6s5r4q3p2o1n0m9l8k7j6i5h4g3f2'),
(39, 1, 'newtest1', '$2y$10$8zm7fsv394F9xWUCcId0V./o2d2uSTv1mHMn8AiebYBKq6ipVda4O', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.S2xhdWRiZWFuVGVzdFRva2Vu.5X9z2_v'),
(40, 2, 'chloelecturer', '$2y$10$/dVFQvdth376hRU2qTucFOjrP9EENUI5A33OWF7UXY.KAMXdpL/K2', 'v1.2a3b4c5d6e7f8g9h0i1j2k3l4m5n6o7p8q9r0s1t2u3v4w5x6y7z8a9b0c1d2e3f');
...
(40, 'Chloe', 'Lecturer', 'chloe@gmail.com', '2025-12-29', '6', 'Triq Bay', 'Valletta', 'VRT 111');
...
ALTER TABLE `user_calendar`
  ADD PRIMARY KEY (`calendarId`),
  ADD KEY `user_calendar_ibfk_1` (`userId`);
...
--
ALTER TABLE `submission_file`
  MODIFY `fileId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `unit_lecturer`
  MODIFY `unitLecturerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `user_calendar`
  ADD CONSTRAINT `user_calendar_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user_account` (`userId`) ON DELETE CASCADE;
